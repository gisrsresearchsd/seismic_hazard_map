...
(function () {
  ...
  const PGA_LOOKUP_TABLE = [
    ...
    { color: [181, 202, 255], min: 0.02, max: 0.03, level: "Low" },
    { color: [143, 179, 255], min: 0.03, max: 0.05, level: "Moderate" },
    { color: [127, 151, 255], min: 0.05, max: 0.08, level: "Moderate" },
    { color: [171, 207, 99], min: 0.08, max: 0.13, level: "High" },
    { color: [232, 245, 158], min: 0.13, max: 0.2, level: "High" },
    { color: [255, 250, 20], min: 0.2, max: 0.35, level: "High" },
    { color: [255, 209, 33], min: 0.35, max: 0.55, level: "High" },
    { color: [255, 163, 10], min: 0.55, max: 0.9, level: "High" },
    { color: [255, 76, 0], min: 0.9, max: 1.5, level: "High" },
  ];
